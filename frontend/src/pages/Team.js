  ...
  return (
    <Box>
              ...
              <CardContent>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <LinearProgress
                    variant="determinate"
                    value={
                      (reviewer.completedCases / reviewer.assignedCases) * 100
                    }
                    color={getProgressColor(
                      reviewer.completedCases,
            ...
            <TableBody>
              {mockReviewers.map((reviewer) => (
                <TableRow key={reviewer.id} hover>
                  ...
                  <TableCell align="center">
                    {(
                      (reviewer.completedCases / reviewer.assignedCases) *
                      100
                    ).toFixed(1)}
                    %
                  </TableCell>
      ...
      <Dialog open={openAssignDialog} onClose={handleCloseAssignDialog}>
        <DialogTitle>Assign Cases to {selectedReviewer?.name}</DialogTitle>
